...
import com.shrewd.develop.updates2k19.Fragment.MyEventsFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_event) {
            fragment = new EventsFragment(mContext);
            CU.displaySelectedFragment(fragment,getSupportFragmentManager(),R.id.frameContainer);
        }
        else if (id == R.id.nav_myevent) {
            fragment = new MyEventsFragment(mContext);
            CU.displaySelectedFragment(fragment,getSupportFragmentManager(),R.id.frameContainer);
